...
class BC_DFL(nn.Module):
    ...
    def __init__(self, Bottleneck,
        ...
        self.classifier_S = Element_Wise_Layer(self.num_classes, 1024)
    ...
    def forward(self, x):
        ...
        feature_ = self.representation(feature) # [32, 2048, 2048]
        ...
        x_S = self.conv(feature) # [32, K*num_classes, 313]
        x_S = self.maxpool(x_S) # [32, K*num_classes, 1]
        x_S = self.leakyrelu(x_S)
        x_S = self.graph_net(x_S.view(x_S.size(0), self.num_classes, -1))  # [32,num_classes, K]
